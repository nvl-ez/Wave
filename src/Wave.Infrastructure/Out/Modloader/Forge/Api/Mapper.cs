...
{
    public static ModloaderInfo ToDomain(string dto, string minecraftVersion) //TODO: SACAR MINECRAFT VERSION DE AQUI: es incorrecto porque no todas las versiones de forge son de la version actual.
    {

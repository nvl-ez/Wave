...
\paragraph{FR-01: View server instances.} The user must be able to view all created server instances. Each item must display enough information to distinguish it from the others, including the server name, icon, execution status and message of the day (MOTD).
